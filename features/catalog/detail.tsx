  ...
  return (
    ...
    <div className="px-6 py-6">
      ...
      <div className="mt-7 flex items-center gap-2.5">
        ...
        {item.url ? (
          <a
            className="inline-flex items-center rounded-full bg-white px-6 py-2.5 font-medium text-[15px] text-black transition-opacity transition-transform duration-100 ease-out hover:opacity-90 focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2 active:scale-[0.97] motion-reduce:transition-none motion-reduce:active:scale-100"
            href={item.url}
